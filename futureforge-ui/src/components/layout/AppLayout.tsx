  ...
  return (
    <div className="relative flex h-screen w-full overflow-hidden bg-white font-sans text-slate-900">
      ...
      <div className="relative z-10 flex-1 flex flex-col min-w-0 bg-transparent">
        <header className="flex h-16 shrink-0 items-center justify-between gap-4 border-b border-slate-200 bg-white/80 backdrop-blur-xl px-6 lg:px-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <Avatar className="h-9 w-9 cursor-pointer border border-cyan-500/30 hover:border-cyan-500 transition-colors shadow-[0_0_10px_rgba(6,182,212,0.2)]">
