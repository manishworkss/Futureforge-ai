  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden pt-24 pb-32">
        ...
        <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-blue-600/20 opacity-20 blur-[100px]"></div>
        
        <div className="container relative mx-auto px-4 sm:px-8 text-center max-w-4xl">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <span className="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-600 dark:border-blue-900/50 dark:bg-blue-900/20 dark:text-blue-400 mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-8">
              Navigate your career with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">AI precision</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link to="/auth/register">
                <Button size="lg" className="h-12 px-8 text-base bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto shadow-xl shadow-blue-600/20">
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeUp}>
                <Card className="h-full border-none shadow-md hover:shadow-xl transition-shadow bg-white dark:bg-slate-950">
                  <CardContent className="p-8">
                    <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/20">
                      {feature.icon}
                    </div>
      ...
      <section id="how-it-works" className="py-24">
        <div className="container mx-auto px-4 sm:px-8 max-w-5xl">
          <motion.div 
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">How FutureForge Works</h2>
          </motion.div>
          ...
          <div className="space-y-12">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true, margin: "-50px" }}
                variants={fadeUp}
                className="flex flex-col md:flex-row items-start md:items-center gap-6 p-6 rounded-2xl bg-slate-50 border border-slate-100 dark:bg-slate-900/50 dark:border-slate-800"
              >
                <div className="text-4xl font-extrabold text-blue-200 dark:text-blue-900/50">
                  {item.step}
                </div>
                <div>
      ...
      <section id="faq" className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4 sm:px-8 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 px-6 py-2 shadow-sm">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left font-medium">Is FutureForge free to use?</AccordionTrigger>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-left font-medium">How accurate is the AI Mentor?</AccordionTrigger>
              <AccordionContent className="text-slate-600 dark:text-slate-400">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left font-medium">Can I change my roadmap later?</AccordionTrigger>
              <AccordionContent className="text-slate-600 dark:text-slate-400">
      ...
      <section className="py-24 border-t border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-4 sm:px-8 text-center max-w-3xl">
          ...
          <Link to="/auth/register">
            <Button size="lg" className="h-14 px-10 text-lg bg-blue-600 hover:bg-blue-700 text-white shadow-xl shadow-blue-600/20">
              Create Free Account
            </Button>
          </Link>
        </div>
