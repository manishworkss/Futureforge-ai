...
import { Eye, EyeOff, ArrowRight, BrainCircuit, Rocket } from 'lucide-react'
          ...
          <div className="relative z-10 w-full max-w-md p-10">
            ...
            >
              ...
              <div className="space-y-5 mt-10">
                {[
                  { title: 'Interactive Learning', desc: 'Engage with AI that adapts to your learning pace.' },
                  { title: 'Industry Insights', desc: 'Get data-backed recommendations for top skills.' },
                  { title: 'Mock Interviews', desc: 'Practice with AI recruiters to ace the real deal.' }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
